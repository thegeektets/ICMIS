	...
	<div id="cl-wrapper" class="fixed-menu">
            ...
            <ul class="cl-vnavigation">
              ...
              <li><a href="#"><i class="fa fa-list-alt"></i><span>Requests</span></a>
                ...
                <ul class="sub-menu">
                  ...
                  <li class="active"><a href="<?php echo base_url('index.php/supervisor/supervisorfellow')?>">Fellows</a></li>
             </ul>
              </li>
        ...
        <div class="col-md-12">
          <div class="block-flat">
            <div class="header">              
              <h3 style="font-weight:300;color:#7C3886">ALLOCATED FELLOW STUDENTS </h3>
            </div>
            <div class="content">
              <div class="table-responsive">
                <table class="table table-bordered" id="datatable-icons" >
                  ...
                  <?php 
                   ...
                   ?>
                                      <tr class="gradeX">
                      <td><?php echo $fellows[$i]['student_name']  ;?></td>
                      <td><?php echo $fellows[$i]['student_institution'] ;?></td>
                      <td><?php echo $fellows[$i]['researchtitle_purposeinternship'] ;?></td>
                      <td><?php echo $fellows[$i]['sd_unit'] ;?></td>
                      <td><?php echo $fellows[$i]['expectedoutput'] ;?></td>
                     <td class="center">
                        <a class="btn btn-flat" type="button" href="<?php echo base_url('index.php/admin/student_profile/').'/'.$fellows[$i]['userid'];?>" target="_blank" 
