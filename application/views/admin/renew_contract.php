...
<li><a href="#"><i class="fa fa-table"></i><span>Applications</span></a>
           ...
           <li  class="active" ><a href="<?php echo base_url('index.php/admin/renew_contract') ?>">Renew Contracts</a></li>
                  </ul>
              </li>
        ...
        <div class="col-sm-12">
              ...
              <div style="width:50%;margin:auto;">
               ...
               <div class="alert alert-success alert-white rounded">
                ...
                <strong style="margin-left:50px">Success!</strong>&nbsp;Contract Edited Successfully
               ...
               <?php
                ...
                <strong style="margin-left:50px"> &nbsp;&nbsp;Warning!</strong>&nbsp;Validation Error

                </div>
                <?php } ?>
        <hr/>

        <form style="margin-bottom: 0px !important;" class="form-horizontal" <?php echo form_open('admin/editcontract/'.$contract['0']['contract_id']); ?>
          <div class="content">
              <div class="form-group">
                ...
                <label class="col-sm-3 control-label"> Student Id</label>
                  <div class="input-group">
                    ...
                    <input type="text" name="student_id" disabled  value="<?php echo $contract['0']['student_id']; ?>" parsley-trigger="change" parsley-error-container="#nick-error" required placeholder="student_id" class="form-control">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-3 control-label"> Student Name</label>
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-user"></i></span>
                    <input type="text" name="student_name" disabled  value="<?php echo $contract['0']['student_name']; ?>" parsley-trigger="change" parsley-error-container="#nick-error" required placeholder="student_id" class="form-control">
                ...
                <div class="col-sm-9">
                  <div class="input-group date datetime col-md-5 col-xs-7" data-min-view="2" data-date-format="yyyy-mm-dd">
                    <input class="form-control"   value="<?php echo $contract['0']['bdate']; ?>"  size="16" name="startdate"type="text" value="" >
                ...
                <div class="col-sm-9">
                  <div class="input-group date datetime col-md-5 col-xs-7" data-min-view="2" data-date-format="yyyy-mm-dd">
                    <input class="form-control"  value="<?php echo $contract['0']['edate'];; ?>"  size="16" name="enddate"type="text" value="" >
                    <span class="input-group-addon btn btn-primary"><span class="glyphicon glyphicon-th"></span></span>
                  </div>          
              ...
              <div class="form-group">
                <div class="col-sm-12">
                <label class="col-sm-3 control-label"> Terms of Reference</label>
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-file"></i></span>
                    <textarea type="text" name="tor"  value="" parsley-trigger="change" parsley-error-container="#nick-error" 
                    required placeholder="TOR" class="form-control">
                      <?php echo $contract['0']['tor']; ?>
                    </textarea> 

          
                  </div>
                  <div id="nick-error"> <?php echo form_error('tor'); ?></div>
                </div>
              </div>
              
              

              <button class="btn btn-block btn-success btn-rad btn-lg" type="submit">Edit Contract</button>
