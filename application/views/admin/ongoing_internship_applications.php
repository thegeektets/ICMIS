            ...
            <ul class="cl-vnavigation">
              ...
              <li><a href="#"><i class="fa fa-list-alt"></i><span>Requests</span></a>
                ...
                <ul class="sub-menu">
                  ...
                  <li  class="active" ><a href="<?php echo base_url('index.php/admin/ongoing_internship_applications') ?>">Ongoing Internship Applications</a></li>
 ...
 <li><a href="#"><i class="fa  fa-bar-chart-o"></i><span>Reports</span></a>
        ...
        <div class="col-md-12">
          <div class="block-flat">
            <div class="header">              
              <h3 style="font-weight:300;color:#7C3886">SHORTLISTED INTERNSHIP APPLICATIONS </h3>
            </div>
            <div class="content">
                   ...
                   ?>
                      ...
                      <td><?php echo $application[$i]['applicant_skills'] ;?></td>
                       ...
                       <td class="center">
                        ...
                        <a class="btn btn-flat" type="button" href="<?php echo base_url('index.php/admin/internship_application/').'/'.$application[$i]['application_id'];?>" target="_blank" 
                         data-original-title="Application Details" data-toggle="tooltip"><i class="fa fa-file"></i></a> 
                         </td>
                         <td>
                        <a class="btn btn-success btn-flat" type="button" href="<?php echo base_url('index.php/admin/accept_iapplication/').'/'.$application[$i]['application_id'].'/'.$application[$i]['request_id'].'/'.$application[$i]['student_id'];?>"  
                         data-original-title="Accept Application" data-toggle="tooltip"><i class="fa fa-file"></i></a> 

                        <a class="btn btn-warning btn-flat" type="button" href="<?php echo base_url('index.php/admin/reject_iapplication/').'/'.$application[$i]['application_id'];?>"  
