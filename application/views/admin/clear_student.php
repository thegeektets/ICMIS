...
<li><a href="#"><i class="fa fa-table"></i><span>Applications</span></a>
           ...
           <li ><a href="<?php echo base_url('index.php/admin/renew_contract') ?>">Renew Contracts</a></li>
                ...
                <ul class="sub-menu">
           <li class="active" ><a href="<?php echo base_url('index.php/admin/clear_student') ?>">Clear Student</a></li>
                  </ul></li>
	...
	<div class="row">
        <div class="col-sm-12">
          ...
          <form style="margin-bottom: 0px !important;" class="form-horizontal" <?php echo form_open('admin/clear_student'); ?>
          <div class="content">
              ...
              <div class="form-group">
                <div class="col-sm-12">
                  <div class="input-group date datetime col-md-12 col-xs-12" data-min-view="2" data-date-format="yyyy-mm-dd">
                    <input class="form-control"   value="<?php echo set_value('cdate'); ?>"  size="16" name="cdate"type="text" required placeholder="Clearance Date" >
                    <span class="input-group-addon btn btn-primary"><span class="glyphicon glyphicon-th"></span></span>
                  </div>          
                <div  style="color:#DF0D8A"  id="cdate-error"> <?php echo form_error('cdate'); ?></div>
        
                </div>
              </div>
            <button class="btn btn-block btn-success btn-rad btn-lg" type="submit">Clear Student</button>
