  ...
  <li><a href="#"><i class="fa fa-folder"></i><span>Contracts</span></a>
        ...
        <div class="col-md-12">
          <div class="block-flat">
            <div class="header">              
              <h3 style="font-weight:300;color:#7C3886">STUDENT CONTRACTS</h3>
            </div>
            <div class="content">
              <div class="table-responsive">
                <table class="table table-bordered" id="datatable-icons" >
                  ...
                  <?php for ($i=0;$i<count($contracts);$i++){
                   ?>
                                      <tr class="gradeX">
                      <td><?php echo $contracts[$i]['student_name']  ;?></td>
                      <td><?php echo $contracts[$i]['student_id'] ;?></td>

                      <td><?php echo $contracts[$i]['bdate']  ;?></td>
                      <td><?php echo $contracts[$i]['edate'] ;?></td>

                      <td><?php echo $contracts[$i]['tor']  ;?></td>
                      <td><?php echo $contracts[$i]['contract_status']  ;?></td>
                      
                                <td class="center">
                
                 <a class="btn btn-success btn-xs" href="<?php echo base_url('index.php/admin/editcontract/').'/'.$contracts[$i]['contract_id'];?>" 
                 id="edit_contract" data-original-title="Edit Contract" data-toggle="tooltip"><i style="" class="fa fa-check"></i></a> 

                 <a class="btn btn-danger btn-xs" href="<?php echo base_url('index.php/admin/deletecontract/').'/'.$contracts[$i]['contract_id'];?>" 
                 id="delete_contract" data-original-title="Delete Contract" data-toggle="tooltip"><i style="" class="fa fa-times"></i></a> 
