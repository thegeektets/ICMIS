          ...
          <div class="content">
            ...
            <ul class="cl-vnavigation">
              ...
              <li><a href="#"><i class="fa fa-envelope nav-icon"></i><span>Vacancies</span></a>
                <ul class="sub-menu">
                  <li class="active" ><a href="<?php echo base_url('index.php/admin/internvacancyactions') ?>">Internship Vacancies</a></li>
                  <li><a href="<?php echo base_url('index.php/admin/fellowvacancyactions') ?>">Fellowship Vacancies</a></li>
                  </ul>
              </li>
