                   ...
                   ?>
                      ...
                      <td><?php echo $supervisors[$i]['useremail'] ;?></td>
                               <td class="center">
                                       ...
                                       <a class="btn btn-default btn-xs" href="<?php echo base_url('index.php/admin/deletesupervisor/').'/'.$supervisors[$i]['userid'];?>" 
                                       id="delete_supervisor" data-original-title="Delete Supervisor" data-toggle="tooltip"><i style="color:#e44c34;" class="fa fa-times"></i></a> 
