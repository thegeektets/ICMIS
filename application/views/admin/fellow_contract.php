	...
	<div class="row">
          <div class="col-sm-12 block-flat">
              ...
              <div class="col-sm-12 pull-left" style ="padding-left:40px;padding-top:20px;font-size:14px;">
                ...
                <h5> <strong style=""><u>RE: Letter of Agreement for a research fellowship at ICRAF</u></strong></h5>
              
              <p style="margin:auto;"> 
               On behalf of the World Agroforestry Centre (ICRAF), I hereby confirm that your application for the fellowship has been successful. This fellowship is awarded to enable you to undertake agroforestry related research under collaboration between ICRAF and Jomo Kenyatta University of Agriculture and Technology. 
               The agreement is subject to the following terms and conditions:     </p>
               ...
               <div class="col-sm-4" style ="padding-left:40px;padding-top:20px;font-size:14px;">
                <strong> Location Research: </strong>
                </div>
               <div class="col-sm-8" style ="padding-left:40px;padding-top:20px;font-size:14px;">
