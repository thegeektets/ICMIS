	...
	<div id="cl-wrapper" class="fixed-menu">
        ...
        <div class="col-md-12">
          <div class="block-flat">
            <div class="header">              
              <h3 style="font-weight:300;color:#7C3886">FELLOWSHIP APPLICATION </h3>
            </div>
            <div class="content">
              <div class="table-responsive">
                <table class="table table-bordered" id="datatable-icons" >
                  ...
                  for ($i=0;$i<count($application);$i++){
                   ?>
                                      <tr class="gradeX">
                      <td><?php echo $application[$i]['application_date']  ;?></td>
                      <td><?php echo $application[$i]['research_title'] ;?></td>
                      <td><?php echo $application[$i]['sponsor'] ;?></td>
                      <td><?php echo $application[$i]['sponsor_contact'] ;?></td>
                      <td><?php echo $application[$i]['applicant_skills'] ;?></td>
                      <td><?php echo $application[$i]['relevantinformation'] ;?></td>
                      <td><?php echo $application[$i]['applicant_requirements'] ;?></td>
