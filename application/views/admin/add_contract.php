...
<li><a href="#"><i class="fa fa-table"></i><span>Applications</span></a>
              ...
              <li><a href="#"><i class="fa fa-folder"></i><span>Contracts</span></a>
                <ul class="sub-menu">
           <li class="active"><a href="<?php echo base_url('index.php/admin/new_contract') ?>">New Contract</a></li>
	...
	<div class="row">
        <div class="col-sm-12">
              ...
              <div style="width:50%;margin:auto;">
               ...
               <div class="alert alert-success alert-white rounded">
                ...
                <strong style="margin-left:50px">Success!</strong>&nbsp;New Contract Added

                </div>
               <?php
                }
                if(strlen($warning['0'])>0){
        ...
        <form style="margin-bottom: 0px !important;" class="form-horizontal" <?php echo form_open('admin/new_contract'); ?>
          <div class="content">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-3 control-label"> Student Id</label>
                  <div class="input-group">
                    ...
                    <input type="text" name="student_id"  value="<?php echo set_value('student_id'); ?>" parsley-trigger="change" parsley-error-container="#nick-error" required placeholder="student_id" class="form-control">
              ...
              <button class="btn btn-block btn-success btn-rad btn-lg" type="submit">Add Contract</button>
