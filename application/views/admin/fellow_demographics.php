           ...
           <li ><a href="<?php echo base_url('index.php/admin/clear_student') ?>">Clear Student</a></li>
              ...
              <li><a href="#"><i class="fa  fa-bar-chart-o"></i><span>Reports</span></a>
                <ul class="sub-menu">
                  ...
                  <li class="active "><a href="<?php echo base_url('index.php/admin/fellow_demographics') ?>">Fellow Demographics</a></li>
                  </ul>
              </li>
  ...
  <div class="row">
        <div class="col-sm-12 block-flat">
             ...
             <div  class="col-sm-12" style="display:block;" >
              ...
              <h3 style = "text-align:center">Male Fellows Distribution Per SD/Unit</h3>
            </div>
            ...
            <div  style="width: 40% ; float:right;display:block;padding:15px;">
             ...
             <div  class="col-sm-12"  style="display:block;" >
              ...
              <h3 style = "text-align:center">Female Fellows Distribution Per SD/Unit</h3>
            </div>
