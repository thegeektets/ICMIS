	...
	<div id="cl-wrapper" class="fixed-menu">
          ...
          <div class="content">
            ...
            <ul class="cl-vnavigation">
              ...
              <li><a href="#"><i class="fa fa-list-alt"></i><span>Requests</span></a>
                ...
                <ul class="sub-menu">
                  <li class="active"><a href="<?php echo base_url('index.php/admin/pending_internship_applications') ?>">Pending Internship Applications</a></li>
        ...
        <div class="col-md-12">
          <div class="block-flat">
            <div class="header">              
              <h3 style="font-weight:300;color:#7C3886">PENDING INTERNSHIP APPLICATIONS </h3>
            </div>
            <div class="content">
                      ...
                      <td><?php echo $application[$i]['applicant_skills'] ;?></td>
                       ...
                       <td class="center">
                        ...
                        <a class="btn btn-flat" type="button" href="<?php echo base_url('index.php/admin/internship_application/').'/'.$application[$i]['application_id'];?>" target="_blank" 
                         ...
                         <td>
                        <a class="btn btn-success btn-flat" type="button" href="<?php echo base_url('index.php/admin/shortlist_iapplication/').'/'.$application[$i]['application_id'];?>"  
