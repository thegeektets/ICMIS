...
<li><a href="#"><i class="fa fa-table"></i><span>Applications</span></a>
           ...
           <li ><a href="<?php echo base_url('index.php/admin/clear_student') ?>">Clear Student</a></li>
            ...
            <li><a href="#"><i class="fa  fa-bar-chart-o"></i><span>Reports</span></a>
                <ul class="sub-menu">
                  ...
                  <li class="active"><a href="<?php echo base_url('index.php/admin/request_charts') ?>">Requests</a></li>
   ...
   foreach ($frequests as $request) {
     # code...
      ...
      $fmonths[] =  date("F", mktime(0, 0, 0, $request['MONTH'], 10)) ." : ".$request['YEAR'];   
  
}
foreach ($irequests as $request) {
     # code...
      $inumber[] =  $request['number']; 
       $imonths[] =  date("F", mktime(0, 0, 0, $request['MONTH'], 10)) ." : ".$request['YEAR']; 
	...
	<div class="row">
        <div class="col-sm-12 block-flat">
             ...
             <div  class="col-sm-12" style="display:block;" >
              ...
              <h3 style = "text-align:center">Intern Requests Received  Per Month Bar Graph</h3>
            </div>
            ...
            <div id="legend"></div>
             ...
             <div  class="col-sm-12"  style="display:block;" >
              ...
              <h3 style = "text-align:center">Fellow Requests Received  Per Month Bar Graph</h3>
            </div>
