	...
	<div id="cl-wrapper" class="fixed-menu">
        ...
        <div class="col-md-12">
          <div class="block-flat">
            <div class="header">              
                  <h3 style="font-weight:300;color:#7C3886">ALUMNI FELLOWS </h3>
            </div>
            <div class="content">
              <div class="table-responsive">
                <table class="table table-bordered" id="datatable-icons" >
                  ...
                  for ($i=0;$i<count($alumni);$i++){
                   ?>
                                      <tr class="gradeX">
                      <td><?php echo $alumni[$i]['cdate']  ;?></td>
                      <td><?php echo $alumni[$i]['bdate'] ;?></td>
                      <td><?php echo $alumni[$i]['edate'] ;?></td>
                      <td><?php echo $alumni[$i]['student_name'] ;?></td>
                      <td><?php echo $alumni[$i]['student_phone'] ;?></td>
                      <td><?php echo $alumni[$i]['student_email'] ;?></td>
                      <td><?php echo $alumni[$i]['applicant_skills'] ;?></td>
                      
                       <td class="center">
                        <a class="btn btn-default btn-xs" target="_blank" href="<?php echo $alumni[$i]['introductionletter'];?>" 
                       ...
                       <td class="center">
                        <a class="btn btn-default btn-xs" target="_blank" href="<?php echo $alumni[$i]['curriculumvitae'];?>" 
                        id="Curriculum_Vitae" data-original-title="Curriculum Vitae" 
                        data-toggle="tooltip"><i style="color:#BAD532;" class="fa fa-file"></i></a> 
                      </td>
                       <td class="center">
                        <a class="btn btn-default btn-xs" target="_blank" href="<?php echo $alumni[$i]['applicant_coverletter'];?>" 
                        id="cover_letter" data-original-title="Cover Letter" data-toggle="tooltip"><i style="color:#BAD532;" class="fa fa-file"></i></a> 
                      </td>
                        <td class="center">
                        <a class="btn btn-flat" type="button" href="<?php echo base_url('index.php/admin/student_profile/').'/'.$alumni[$i]['userid'];?>" target="_blank" 
