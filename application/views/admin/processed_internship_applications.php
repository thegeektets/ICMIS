	...
	<div id="cl-wrapper" class="fixed-menu">
            ...
            <ul class="cl-vnavigation">
              ...
              <li><a href="#"><i class="fa fa-list-alt"></i><span>Requests</span></a>
                ...
                <ul class="sub-menu">
                  ...
                  <li class="active"><a href="<?php echo base_url('index.php/admin/processed_internship_applications') ?>">Processed Internship Applications</a></li>
        ...
        <div class="col-md-12">
          <div class="block-flat">
            <div class="header">              
              <h3 style="font-weight:300;color:#7C3886">PROCESSED INTERNSHIP APPLICATIONS </h3>
            </div>
            <div class="content">
                      ...
                      <td><?php echo $application[$i]['applicant_skills'] ;?></td>
                       ...
                       <td class="center">
                        ...
                        <a class="btn btn-flat" type="button" href="<?php echo base_url('index.php/admin/internship_application/').'/'.$application[$i]['application_id'];?>" target="_blank" 
                         ...
                         <td>
                        <a class="btn btn-danger btn-flat" type="button" href="<?php echo base_url('index.php/admin/delete_iapplication/').'/'.$application[$i]['application_id'];?>"  
                         data-original-title="Delete Application" data-toggle="tooltip"><i class="fa fa-file"></i></a> 
                      </td>
                    </tr>
                    <?php }
                    ?>
