          ...
          <div class="content">
            ...
            <li><a href="#"><i class="fa fa-list-alt"></i><span>Requests</span></a>
                <ul class="sub-menu">
                  ...
                  <li class="active" ><a href="<?php echo base_url('index.php/admin/ongoing_internrequests') ?>">Ongoing Intern Requests</a></li>
      ...
      <li><a href="#"><i class="fa fa-table"></i><span>Applications</span></a>
        ...
        <div class="col-md-12">
          <div class="block-flat">
            <div class="header">              
              <h3 style="font-weight:300;color:#7C3886">ONGOING INTERNSHIP VACANCIES </h3>
            </div>
            <div class="content">
