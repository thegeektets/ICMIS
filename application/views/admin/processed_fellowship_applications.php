             ...
             <li><a href="#"><i class="fa fa-list-alt"></i><span>Requests</span></a>
              ...
              <li><a href="#"><i class="fa fa-table"></i><span>Applications</span></a>
                <ul class="sub-menu">
                  ...
                  <li class="active"><a href="<?php echo base_url('index.php/admin/processed_fellowship_applications') ?>">Processed Fellowship Applications</a></li>
   ...
   <li><a href="#"><i class="fa  fa-bar-chart-o"></i><span>Reports</span></a>
        ...
        <div class="col-md-12">
          <div class="block-flat">
            <div class="header">              
              <h3 style="font-weight:300;color:#7C3886">PROCESSED FELLOWSHIP APPLICATIONS </h3>
            </div>
            <div class="content">
                   ...
                   ?>
                      ...
                      <td><?php echo $application[$i]['applicant_skills'] ;?></td>
                       ...
                       <td class="center">
                        ...
                        <a class="btn btn-danger btn-flat" type="button" href="<?php echo base_url('index.php/admin/delete_fapplication/').'/'.$application[$i]['application_id'];?>"  
